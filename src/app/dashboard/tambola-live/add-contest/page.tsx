...
const Client_Registration = () => {
    ...
    const handleToBack = () => {
        router.push("/dashboard/tambola-live");
    };

    return (
        <>
            <BreadCrumb name='Tambola Live Contests Add' buttonText='Back' symbolIcon={<RdIcon iconName="backPage" />} onClick={handleToBack}></BreadCrumb>
