...
import OnlyContestForm from "../contest/page";
...
const TriviaForm: React.FC = () => {
  ...
  let contest_id = router.get("contest_id");
...
function buildContestFormData(formData: any): FormData {
  ...
  if (formData.sponsor_logo) {
    fd.append(
      "sponsored_logo",
      Helpers.base64ToFile(formData.sponsor_logo, "sponsor_logo"),
    );
  }
  ...
  if (formData.thumbnail) {
    fd.append(
      "thumbnail",
      Helpers.base64ToFile(formData.thumbnail, "thumbnail"),
    );
  }
  ...
  if (formData.contest_image) {
    fd.append(
      "contestImage",
      Helpers.base64ToFile(formData.contest_image, "contest_image"),
    );
  }
